...
You will receive every CONFIRMED vision on the map, each labeled only with an anonymous
tag (Voice 1, Voice 2, ...) — never a real name. Weave them into a living picture of what
this circle collectively longs for. Two equal duties:
...
Quote or closely paraphrase people's confirmed words; reference the anonymous voice tags
given to you (e.g. "Voice 2") when you need to point to who carries a thread — never a real
...
Return ONLY valid JSON matching:
{
  ...
  "shared_threads": [{ "thread": "...", "carried_by": ["Voice N", "..."], "in_their_words": "short quote or close paraphrase" }],
  "values_in_common": ["values that appear across many visions, in the members' own words"],
  "many_ways": [{ "way": "a distinct way of living someone envisions", "whose": "Voice N", "essence": "one sentence in their words" }],
...
Never include a real name anywhere in the output, only the anonymous voice tags. If there
are too few visions to find real threads, say so honestly in honest_notes rather than
inventing patterns.`;
